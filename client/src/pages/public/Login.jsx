...
const demoAccounts = [
  {
    role: 'Job Seeker',
    email: 'ujjawalsaini1@gmail.com',
    password: 'UjjawalSmartPortal',
  },
  {
    role: 'Recruiter',
    email: 'bt23csh039@iiitn.ac.in',
    password: 'UjjawalSmartPortal',
  },
  {
    role: 'Admin',
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-accent-50 dark:from-dark-bg dark:via-dark-bg-secondary dark:to-dark-bg p-4 flex items-center justify-center">
      <div className="w-full max-w-7xl grid lg:grid-cols-[1fr_380px] gap-6 items-start">
        ...
        >
          <div className="bg-white dark:bg-dark-bg-secondary border border-primary-100 shadow-lg rounded-2xl p-6">
            <div className="flex items-center gap-2 mb-3">
              <CheckCircle className="w-5 h-5 text-primary-600" />
              <h2 className="font-semibold text-lg text-light-text dark:text-dark-text">
                Demo Credentials Available
              </h2>
            </div>

            <p className="text-sm text-light-text-secondary dark:text-dark-text-secondary mb-5 leading-relaxed">
              Explore SmartHire instantly using demo accounts for Job Seeker,
            ...
            <div className="space-y-4">
              {demoAccounts.map((account) => (
                <div
                  key={account.role}
                  className="border rounded-xl p-4 bg-gray-50 dark:bg-dark-bg"
                >
                  <p className="font-semibold text-sm mb-3">{account.role}</p>
